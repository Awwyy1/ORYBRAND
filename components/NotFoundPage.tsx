  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex flex-col items-center justify-center text-center px-6">
      ...
      >
        ...
        <p className="brand-font text-sm md:text-lg tracking-[0.5em] text-sky-600 mb-6 uppercase">
          Page Not Found
        </p>
        <p className="text-slate-600 text-sm max-w-md mx-auto mb-12 leading-relaxed font-light">
