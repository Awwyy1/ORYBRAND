    ...
    <footer className="bg-black border-t border-white/5 py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="text-center md:text-left">
          ...
          <p className="text-xs text-slate-400 max-w-xs leading-relaxed uppercase tracking-widest">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
          <div>
            ...
            <ul className="text-xs space-y-2 text-slate-400 uppercase tracking-widest">
